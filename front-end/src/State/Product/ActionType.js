...
export const FIND_PRODUCT_REQUEST='FOND_PRODUCT_BY_CATEGORY_REQUEST';
export const FIND_PRODUCT_SUCCESS='FOND_PRODUCT_BY_CATEGORY_SUCCESS';
export const FIND_PRODUCT_FAILURE='FOND_PRODUCT_BY_CATEGORY_FAILURE';
