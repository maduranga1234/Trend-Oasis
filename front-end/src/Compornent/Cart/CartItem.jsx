    ...
    <div className='p-5 border rounded-md shadow-lg'>
      <div className='flex items-center'>
        ...
        <div className='ml-5 space-y-1'>
          ...
          <div className='flex items-center pt-6 space-x-2 text-gray-900 lg:text-xl'>
      ...
      <div className='flex items-center pt-4 space-x-10'>
        <div className='flex items-center space-x-2'>
          ...
          <span className='py-1 border rounded-sm px-7'>1</span> {/* Add quantity here */}
