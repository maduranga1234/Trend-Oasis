    ...
    <div onClick={()=>navigate(`/account/order/${5}`)} className="p-5 border shadow-md shadow-black hover:shadow-2xl">
      ...
      <Grid container spacing={2} sx={{ justifyContent: "space-between" }}>
        <Grid item xs={6}>
          <div className="flex cursor-pointer">
            ...
            <div className="ml-5 space-y-2">
              ...
              <p className="text-xs font-semibold opacity-50">Color: Black</p>
            </div>
          </div>
        </Grid>
        <Grid item xs={2}>
        ...
        {true&& <div>
            ...
            <p>
            <RadioButtonCheckedIcon sx={{width:"15px",height:"15px"}} className="mr-2 text-sm text-green-600"/>
            <span>Delivered On May 21</span>
